local HomingMissile = {
    ...
    onDestroy = function (lthis, this) 
        ...
        em:setParticleLifetime(thor.Distributions.timeUniform(sf.seconds(0.4), sf.seconds(1.5)))
        ...
        pso:setRemoveAfterLifetime(1.8)
        pso.system:addTextureRect(sf.IntRect.new(0, 19, 8, 8))
        pso.system:addTextureRect(sf.IntRect.new(8, 19, 8, 8))
        pso.system:addTextureRect(sf.IntRect.new(16, 19, 8, 8))
        pso.system:addTextureRect(sf.IntRect.new(24, 19, 7, 8))
        pso.system:addTextureRect(sf.IntRect.new(31, 19, 9, 9))
        pso.system:addTextureRect(sf.IntRect.new(40, 19, 8, 9))
        

        local fade = thor.FadeAnimation.new(0, 0.5)
        local fadeAffector = thor.AnimationAffector.new(fade)

        pso.system:addAffector(fadeAffector)
